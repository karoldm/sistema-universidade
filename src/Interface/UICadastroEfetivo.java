...
public class UICadastroEfetivo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(403, 309));

        LabelCadastro.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        LabelCadastro.setText("Funcionário cadastrado com sucesso !");
    ...
    private void TextFieldCodigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextFieldCodigoFocusLost
        ...
        if(E != null){
            ...
            LabelCadastro.setText("Funcionário já cadastrado!");
            LabelCadastro.setVisible(true);
